...
import { LukasakovaAmbulanceWlEditor } from '../lukasakova-ambulance-wl-editor';
...
describe('lukasakova-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [LukasakovaAmbulanceWlEditor],
      html: `<lukasakova-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></lukasakova-ambulance-wl-editor>`,
    });
